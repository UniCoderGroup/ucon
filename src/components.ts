...
export type BlockComponentConstructor<C extends BlockComponent<P>, P> = new (porps: P, con?: ConForBlock) => C;
...
export type ContainerComponentConstructor<C extends ContainerComponent<P>, P> = new (porps: P, con?: ConForContainer) => C;
